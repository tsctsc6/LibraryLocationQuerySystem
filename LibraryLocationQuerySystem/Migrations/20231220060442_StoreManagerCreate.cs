    ...
    public partial class StoreManagerCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Store", x => new { x.BookSortCallNumber, x.BookFormCallNumber, x.LocationLevel, x.LocationId, x.LocationParent });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Store_Location_LocationLevel_LocationId_LocationParent",
                        columns: x => new { x.LocationLevel, x.LocationId, x.LocationParent },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Store_LocationLevel_LocationId_LocationParent",
                table: "Store",
                columns: new[] { "LocationLevel", "LocationId", "LocationParent" });
        }
